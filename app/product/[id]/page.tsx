...
import { ChevronLeft, ShoppingCart, ShieldCheck, MapPin, MessageCircle, MessageSquare } from "lucide-react";
        ...
        {item ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="bg-gray-50 rounded-2xl mb-8 border border-gray-100">
                <h3 className="font-bold mb-2">Deskripsi Produk</h3>
                <p className="text-gray-600 leading-relaxed">{item.description}</p>
              </div>

              <div className="flex items-center gap-4 mb-8 p-4 border border-gray-300 rounded-2xl">
              ...
              <div className="flex gap-4">
                <button
                  className="cursor-pointer flex-1 bg-blue-600 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-blue-700 shadow-lg shadow-blue-200 transition"
                  onClick={handleChat}
                >
