...
import { ChevronLeft, MessageSquare, Edit, Trash2, UserIcon, MapPin } from "lucide-react"; // Tambah icon
          ...
          {item ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-xl font-black text-indigo-700 mb-1">Rp{formatIDR(item.price)}</p>
