        ...
        <div className="flex items-center gap-2 md:gap-4">
          {user ? (
            <>
              ...
              >
                <Plus size={18} /> <span className="hidden sm:inline">Mulai Jual</span>
              </button>
            ...
            <div className="flex items-center gap-2">
              <button onClick={() => router.push("/login")} className="text-sm font-bold px-4 py-2 text-slate-600 hover:text-indigo-600 transition">Masuk</button>
              <button onClick={() => router.push("/register")} className="text-sm font-bold px-5 py-2.5 bg-slate-900 text-white rounded-xl hover:bg-slate-800 transition shadow-xl shadow-slate-200">Daftar</button>
            </div>
          )}
        </div>
      </div>
