    ...
    <nav className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2 cursor-pointer group" onClick={() => router.push("/")}>
          ...
          <h1 className="text-xl font-black tracking-tighter text-indigo-900">RE<span className="text-indigo-600">WEAR</span></h1>
        </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            {user ? (
              <Link
                href="/profile"
                id="profile"
                className="flex items-center gap-3 bg-slate-50 p-1 pr-3 rounded-full border border-slate-100 cursor-pointer hover:bg-slate-100 transition"
              >
